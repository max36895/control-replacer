...
function runReplaces<TParam extends ICorrectParam<TCbReplace>, TCbReplace = TReplace>(
    param: TParam,
    cb: (replace: TCbReplace) => void,
) {
...
function runControlReplaces(
    param: ICorrectParam<IReplace>,
    replacer: Replacer,
